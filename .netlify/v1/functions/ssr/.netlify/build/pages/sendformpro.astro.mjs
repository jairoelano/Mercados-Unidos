...
var _a;
const $$SendFormPro = createComponent(async ($$result, $$props, $$slots) => {
...
const voydomicilio = document.getElementById("voydomicilio");
...
voydomicilio.addEventListener("change", function () {
    if (voydomicilio.value === "") {
        ...
        ventaonlineCheckbox.addEventListener('change', function () {
            ...
            if (this.checked) {
                ...
                validacionDireccion.textContent = '\u274C Debes poner una direcci\xF3n'
...
horaFinManTest.addEventListener('change', function () {
    ...
    if(horaFinManTest.value === '' || horaFinManTest.value === '00:00'){
      errorMessageHora.textContent ='Debes poner un horario \u274C'
...
function actualizarMensajeHora() {
    if (isHoraManValid && isHoraTarValid) {
        ...
        async function verificarNombre(nombre) {
            try {
                const docRef = doc(db, 'datos-profesionales', nombre);
        ...
        form.addEventListener('submit', async (event) => {
            ...
            if (!cargarLuego && imageUrls.length === 0) {
              ...
              return;
                ...
                const voydomicilio = document.getElementById('voydomicilio').value;
                ...
                const errorMensajeComercio = document.getElementById('validacion-profesion');
                ...
                if (profesion === "") {
                alert('\xA1Porfavor! Coloca el tipo de profesion u oficio')
                errorMensajeComercio.textContent = '\u274C Coloca el tipo de profesi\xF2n / oficio';
                ...
                if(nombre === ''){
                  alert('\xA1Porfavor! Coloca tu nombre y apellido')
                  errorMensajeNombre.textContent = 'Coloca tu nombre y apellido \u274C'
                ...
                if (email === "") {
                alert('\xA1Porfavor! Coloca tu email de contacto')
                errorMensajeEmail.textContent = '\u274C Coloca tu email de contacto.';
                ...
                if (telefono === "") {
                alert('\xA1Porfavor! Coloca un telefono de contacto')
                errorMensajeTelefono.textContent = '\u274C Coloca al menos un telefono de contacto';
                ...
                alert('\xA1Porfavor! Coloca una direccion o si vendes online')
                ...
                if (descripcion === "") {
                alert('\xA1Porfavor! Describe tu servicio')
                errorMensajeDescripcion.textContent = '\u274C Coloca una descripci\xF2n de 120 caracteres min.';
    ...
    if (email === "") {
      mensajeEmail.textContent = "\u274C Debes poner un e-mail";
  ...
  if (comercio === "") {
    mensajeComercio.textContent = "\u274C Debes poner tu profesion u oficio.";
  ...
  if (regex.test(comercio)) {
    mensajeComercio.textContent = "\u2705 Profesi\xF3n u oficio v\xE1lido";
    mensajeComercio.style.display = "block";
    mensajeComercio.style.color = "green"
    mensajeComercio.classList.add('text-xs', 'p-2', 'font-bold')
  } else {
    mensajeComercio.textContent = "\u274C No v\xE1lido. Ej: Medico / Herrero";
    mensajeComercio.style.display = "block";
    mensajeComercio.style.color = "red"
    mensajeComercio.classList.add('text-xs', 'p-2', 'font-bold')
  }
...
document.getElementById("nombre").addEventListener("keyup", function() {
  ...
  if (nombre === "") {
    mensajeNombre.textContent = "\u274C Debes tu nombre y apellido";
  ...
  if (regex.test(nombre)) {
    mensajeNombre.textContent = "\u2705 Nombre y apellido validos";
    mensajeNombre.style.display = "block";
    mensajeNombre.style.color = "green"
    mensajeNombre.classList.add('text-xs', 'p-2', 'font-bold')  
  } else {
    mensajeNombre.textContent = "\u274C No v\xE1lido. Ej: Juan Dominguez";
    mensajeNombre.style.display = "block";
    mensajeNombre.style.color = "red"
    mensajeNombre.classList.add('text-xs', 'p-2', 'font-bold') 
  }
...
telefonoInput.addEventListener("input", function() {
  ...
  if (telefonos === "") {
    mensajeTelefono.textContent = "\u274C Debes poner un telefono";
...
document.getElementById("direccion").addEventListener("input", function() {
  ...
  if (direccion === "") {
    mensajeDireccion.textContent = "\u274C Debes poner una direccion";
...
document.getElementById("descripcion").addEventListener("keyup", function() {
  ...
  if (descripcion === "") {
    mensajeDescripcion.textContent = "\u274C Debes poner una descripcion de 120 caracteres min.";
...
Publica tu Profesión o Oficio
</h3> </div> <div class="p-4 md:p-5 border-gray-600 rounded-b-lg"> <form class="p-4 md:p-5" id="contactForm"> <!-- Campos del formulario --> <div class="grid gap-4 mb-4 grid-cols-2"> <!-- Profesión --> <div class="col-span-2"> <label for="profesion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Profesión o Oficio <small class="text-gray-700 px-2">(requerido)</small></label> <input type="text" name="profesion" id="profesion" class="border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: Dentista o Herrero"> <p id="validacion-profesion" style="display: none"></p> </div> <!-- Nombre --> <div class="col-span-2"> <label for="nombre" class="block mb-2 text-sm font-medium text-white">Nombre y Apellido <small class="text-gray-700 px-2">(requerido)</small></label> <input type="text" name="nombre" id="nombre" class="border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: Juan Carlos González"> <p id="validacion-nombre" style="display: none"></p> </div> <!-- Email --> <div class="col-span-2"> <label for="email" class="block mb-2 text-sm font-medium text-white">Email <small class="text-gray-700 px-2">(requerido)</small></label> <input type="email" name="email" id="email" class="border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: Carlos1@email.com"> <p id="validacion-email" style="display: none"></p> </div> <!-- Teléfono --> <div class="col-span-2"> <label for="telefono" class="block text-sm font-medium text-white">Teléfonos <small class="text-gray-700 px-2">(requerido)</small></label> <small class="text-teal-800 text-xs">Podés agregar más de uno separados por un "-"</small> <input type="number" name="telefono" id="telefono" class="border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: 343-xxx xxxx"> <p id="validacion-telefono" style="display: none"></p> </div> <!-- Dirección --> <div class="col-span-2"> <label for="direccion" class="block text-sm font-medium text-white">Dirección</label> <small class="text-teal-800 text-xs">Podés agregar más de una dirección separadas por una "/"</small> <input type="text" name="direccion" id="direccion" class="border text-xs rounded-lg block w-full p-2.5 bg-black/30  border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: Mi calle  1234"> <div class="flex gap-2 mt-3 mb-3"> <label for="ventaonline" class="text-gray-300 text-xs font-semibold">Solo trabajo a domicilio</label> <input type="checkbox" id="ventaonline" class="border-none bg-gray-500 rounded-xs"> </div> <p id="validacion-direccion" style="display: none"></p> </div> <!-- Web --> <div class="col-span-2 mb-3"> <label for="web" class="block mb-2 text-sm font-medium text-white">Web <small class="text-gray-700 px-2">(opcional)</small></label> <input type="url" name="web" id="web" class="border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: www.mipaginaweb.com"> <p id="validacion-web" style="display: none"></p> </div> <!-- Redes --> <div class="col-span-2 mb-3"> <label for="redes" class="block text-sm font-medium text-white">Redes <small class="text-gray-700 px-2">(opcional)</small></label> <small class="text-teal-800 text-xs">Agrega las URLs de las redes sociales o el nickname.</small> <textarea name="redes" id="redes" class="h-24 border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Ej: https://instagram.com/... o @minegocio_ok"></textarea> <p id="validacion-red-social" style="display: none"></p> </div> <!-- Descripción --> <div class="col-span-2"> <label for="descripcion" class="block text-sm font-medium text-white mb-2">Describe tu Servicio <small class="text-gray-700 px-2">(requerido)</small><small class="text-gray-700 px-2">(150 caracteres max.)</small></label> <textarea id="descripcion" rows="4" maxlength="150" class="h-24 border text-xs rounded-lg block w-full p-2.5 bg-black/30 border-gray-500 placeholder-slate-700 text-white" placeholder="Haz una breve descripción del servicio que brindas"></textarea> <p id="validacion-descripcion" style="display: none"></p> </div> <!-- Métodos de Pago --> <div class="border border-gray-600 p-4 rounded-lg col-span-2 mt-3 mb-3"> <h5 class="font-medium text-white mt-2 mb-3 flex items-center">Medios de pago <small class="text-gray-700 px-2">(requerido)</small><small id="messageMetodos" style=" display: none" class="ml-3"></small></h5> <div class="col-span-2"> <fieldset id="metodos" class="col-span-2 grid grid-cols-2"> <div class="flex gap-3 items-center"> <label class="block text-white mt-3 mb-2 text-xs"> <input type="checkbox" name="metodos" id="todoslosmedios" class="w-3 h-3 border-none bg-gray-500 rounded-xs mr-2">Todos los medios
...
</label> </div> </fieldset> </div> <!-- Mensaje de error para métodos de pago --> <p id="error-message-metodos" style=" display: none" class="text-red-800 font-bold text-xs pt-3">Debes seleccionar al menos un método de pago.</p> </div> <!-- Voy a domicilio --> <div class="col-span-2 border border-gray-600 p-4 w-full rounded-lg mb-3"> <div class="col-span-2 mt-2"> <div class="flex"> <label for="voydomicilio" class="block text-white mb-3">Voy a domicilio <small class="text-gray-700 px-2">(requerido)</small></label> <small id="message-domicilio" style=" display: none"></small> </div> <select id="voydomicilio" name="voydomicilio" class="w-full text-xs border-none rounded-lg bg-gray-900 text-gray-200"> <option value=""></option> <option value="si">Si</option> <option value="no">No</option> <option value="consultar">Consultar</option> </select> </div> <div class="mt-3"> <p id="error-message-domicilio" style=" display: none" class="text-red-500 font-bold text-xs"></p> </div> </div> <!-- Horarios --> <div class="col-span-2 mb-4 border border-gray-600 p-4 rounded-lg"> <div class="flex"> <h5 class="text-white mb-3">Horario laboral <small class="text-gray-700 px-2">(requerido)</small></h5> <small id="mensaje-hora" style="display: none;"></small> </div> <p class="text-xs text-gray-500 underline mb-2">De mañana</p> <div class="flex items-center gap-10 justify-between mb-3"> <div class="flex justify-center items-center relative"> <label class="block text-white mt-3 mb-2 text-xs" for="hora-inicio-man">Hora de inicio:</label> <div class="relative"> <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none"> <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"> <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"></path> </svg> </div> <input type="time" id="hora-inicio-man" name="hora-inicio-man" class=" border leading-none  h-8 text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white" min="01:00" max="13:00" value="00:00"> </div> </div> <div class="flex items-center relative"> <label class="block text-white mt-3 mb-2 text-xs" for="hora-fin-man">Hora de cierre:</label> <div class="relative"> <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none"> <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"> <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"></path> </svg> </div> <input type="time" id="hora-fin-man" name="hora-fin-man" class=" border leading-none  h-8 text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white" min="01:00" max="13:00" value="00:00"> </div> </div> </div> <div class="col-span-2 mb-2"> <p class="text-xs text-gray-500 underline">De tarde</p> <div class="flex items-center gap-10 justify-between mb-3"> <div class="flex items-center relative"> <label class="block text-white mt-3 mb-2 text-xs" for="hora-inicio-tar">Hora de inicio:</label> <div class="relative"> <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none"> <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"> <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"></path> </svg> </div> <input type="time" id="hora-inicio-tar" name="hora-inicio-tar" class=" border leading-none  h-8 text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white" min="13:00" max="24:00" value="00:00"> </div> </div> <div class="flex items-center relative"> <label class="block text-white mt-3 mb-2 text-xs" for="hora-fin-tar">Hora de cierre:</label> <div class="relative"> <div class="absolute inset-y-0 end-0 top-0 flex items-center pe-3.5 pointer-events-none"> <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"> <path fill-rule="evenodd" d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4a1 1 0 1 0-2 0v4a1 1 0 0 0 .293.707l3 3a1 1 0 0 0 1.414-1.414L13 11.586V8Z" clip-rule="evenodd"></path> </svg> </div> <input type="time" id="hora-fin-tar" name="hora-fin-tar" class=" border leading-none  h-8 text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white" min="13:00" max="24:00" value="00:00"> </div> </div> </div> </div> <div class="flex gap-8 mt-4"> <div class="flex gap-3"> <label class="text-gray-300 text-xs" for="decorrido">Trabajo de corrido</label> <input type="checkbox" id="decorrido" name="decorrido" class="border-none rounded-xs bg-gray-500"> </div> <div class="flex gap-3"> <label class="text-gray-300 text-xs" for="24-7">Trabajo 24 horas</label> <input type="checkbox" id="24-7" name="24-7" class="border-none rounded-xs bg-gray-500"> <small class="text-gray-700">(opcional)</small> </div> </div> <div class="mt-3"> <p style="display: none" id="error-message-hora-mañana" class="text-red-500 font-bold text-xs"></p><p style="display: none" id="error-message-hora-tarde" class="text-red-500 font-bold text-xs"></p><p style="display: none" id="error-message-hora" class="text-red-500 font-bold text-xs"></p> </div> </div> <!-- Días Laborales --> <div class="col-span-2 mb-5 border border-gray-600 rounded-lg p-4"> <fieldset class="w-full" id="Dias"> <div class="flex"> <legend class="text-white mb-4">Días laborales <small class="text-gray-700 px-2">(requerido)</small></legend> <small id="message-dias" style="display: none"></small> </div> <div class="grid grid-cols-3 gap-2 w-full mb-3"> <label class="text-white text-xs"> <input type="checkbox" name="dias" value="lunes" class="border-none bg-gray-500 rounded-xs mr-2"> Lunes
